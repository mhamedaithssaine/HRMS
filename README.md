...
# Objectives
 -Allow each company to create an account and manage its employees.
 -Assign various roles to users for flexible permission management.
...
2. Employee Management
 ...
 -Career tracking (promotions, training, salaries, history).
 -Contract management: permanent, fixed-term, internship, freelance, via Laravel Media Library.
3. Departments & Hierarchy
 -Create departments to structure the company.
 -Assign employees to departments.
 -Define internal hierarchical relationships.
 -Interactive display of the organizational chart (drag-and-drop possible).
   # Technical Stack
Backend: Laravel 11
Frontend: Blade, Tailwind CSS, Livewire
Packages:
Spatie Laravel-Permission (Roles & permissions)
Laravel Media Library (Contracts & documents)
Yajra Datatables (optional)
Database: MySQL
Others: Laravel Breeze or Jetstream (auth), Seeders, Factories
# Pedagogical Modalities
Individual work
-📅 Duration: 5 days
-🕘 Start: February 24, 2025, at 09:15 AM
-🕔 End: February 28, 2025, before 05:30 PM
