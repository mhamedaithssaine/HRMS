            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200">Liste des Emplois</h3>
                        <a href="{{ route('emplois.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-300 flex items-center">
                                ...
                                @foreach ( $emplois as $emploi)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">
                                            {{ $emploi->department->name }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                            <div class="flex justify-center space-x-3">
                                                <a href="{{ route('emplois.show', $emploi->id) }}" class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 flex items-center">
                                ...
                                @if(count($emplois) === 0)
                                    <tr>
                                        <td colspan="3" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                            ...
                                            <p class="mt-1 text-sm">Commencez par ajouter un nouvel emploi</p>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                    ...
                    @if(count($emplois) > 0 && method_exists($emplois, 'links'))
                        <div class="mt-4">
                            {{ $emplois->links() }}
                        </div>
                    @endif
