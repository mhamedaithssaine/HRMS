            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200">Liste des Départements</h3>
                        <a href="{{ route('departments.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-300 flex items-center">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                            <div class="flex justify-center space-x-3">
                                                <a href="{{ route('departments.show', $department->id) }}" class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 flex items-center">
                                                ...
                                                <a href="{{ route('departments.edit', $department->id) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 flex items-center">
                                                ...
                                                <form action="{{ route('departments.destroy', $department->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 flex items-center" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce département?')">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                @if(count($departments) === 0)
                                    <tr>
                                        <td colspan="3" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                            ...
                                            <p class="mt-1 text-sm">Commencez par ajouter un nouveau département</p>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                    ...
                    @if(count($departments) > 0 && method_exists($departments, 'links'))
                        <div class="mt-4">
                            {{ $departments->links() }}
                        </div>
                    @endif
